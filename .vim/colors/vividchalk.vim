...
call s:hifg("Normal","#EEEEEE","White",7)
if &background == "light" || has("gui_running")
    hi Normal guibg=Black ctermbg=Black
else
    hi Normal guibg=Black ctermbg=NONE
endif
highlight StatusLine    guifg=Black   guibg=#aabbee gui=bold ctermfg=Black ctermbg=Grey cterm=bold
...
highlight PmenuThumb    guibg=Grey ctermbg=Grey
...
call s:hifg("Type"           ,"#fd3232","LightRed",57) " 101
call s:hifg("railsUserClass" ,"#AAAAAA","Grey",7) " 101
call s:hifg("Special"        ,"#33AA00","DarkGreen",24) " 7
call s:hifg("Regexp"         ,"#44B4CC","DarkCyan",21) " 74
call s:hifg("rubyMethod"     ,"#AACCFF","LightCyan",77) " 191
